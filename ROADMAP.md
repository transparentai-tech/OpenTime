...
- [x] Web dashboard
- [x] Passive hooks for 6 IDEs (Claude Code, Cursor, Cline, Copilot, Windsurf, Amazon Q)
...
- [ ] **VS Code extension** — Sidebar panel showing active tasks, duration stats, and a mini-dashboard. Covers Cursor, Windsurf, Cline, Copilot, and Void.
...
Have an idea? Open an issue at [github.com/SyntheticCognitionLabs/OpenTime/issues](https://github.com/SyntheticCognitionLabs/OpenTime/issues).
